...
*   `getDetailsMenu`: This function constructs a dynamic menu for detail views, incorporating items from `detail.menu` and a predefined `menuV4`.
    ...
    *   **At 18:57:34:** The logic to add a "Remove from Continue Watching" button was commented out, explicitly noting "CCMA-2058 - Ocultar el botón de 'Eliminar' del 'Estic reproduint'" (Hide the 'Delete' button from 'Currently playing').
